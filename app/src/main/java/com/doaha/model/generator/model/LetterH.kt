...
class LetterH (centerPoint: LatLng, offset: Int) : Character(centerPoint, offset) {
    override fun generateCharacterJSONArrayObject(): JSONArray {
        ...
        //3
        jsonArrayChild.put(funCreateLatLngPoint(startPointLat+2*longLine/3, startPointLong+longLine/3))
        //4
        jsonArrayChild.put(funCreateLatLngPoint(startPointLat+2*longLine/3, startPointLong+2*longLine/3))
        //5
